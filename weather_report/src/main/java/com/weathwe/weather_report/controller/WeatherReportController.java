...
import com.weathwe.weather_report.service.CityDataFeignService;
...
public class WeatherReportController {
    ...
    //todo 调用天气数据微服务
    @Autowired
    private CityDataFeignService cityDataFeignService;
    ...
    public ModelAndView getReportByCityId(@PathVariable("cityId") String cityId, Model model) throws IOException, JAXBException {
        ...
        //todo 同上
        model.addAttribute("cityList",cityDataFeignService.getCityList());
